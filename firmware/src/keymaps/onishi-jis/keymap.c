...
// TODO: JP_ZKHK, JP_MHEN, JP_HENK, JP_KANA
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        JP_Q,   JP_L,   JP_U,   JP_COMM,    JP_DOT,                                 JP_F,   JP_W,   JP_R,   JP_Y,   JP_P,
        JP_E,   JP_I,   JP_A,   JP_O,       JP_MINS,                                JP_K,   JP_T,   JP_N,   JP_S,   JP_H,
        JP_Z,   JP_X,   JP_C,   JP_V,       JP_SCLN,                                JP_G,   JP_D,   JP_M,   JP_J,   JP_B,
...
const key_override_t unds_key_override = ko_make_basic(MOD_MASK_SHIFT, JP_COMM, JP_UNDS);
const key_override_t bspc_key_override = ko_make_basic(MOD_MASK_SHIFT, JP_DOT, KC_BSPC);
